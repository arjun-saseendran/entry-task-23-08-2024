              ...
              <div key={index} className=" col-12 col-sm-6 col-md-4 col-lg-3 mt-3">
                <div className="card overfolw-hidden" style={{ width: "18rem", height:'30rem'}}>
                  ...
                  <div className="card-body" style={{height:'25rem', overflow:'hidden'}}>
                    <h5 className="card-title text-secondary" style={{height:'3rem', overflow: 'hidden'}}>{product.title}</h5>
  
                    <p className="card-text overflow:hidden text-secondary" style={{height:'6rem', overflow: 'hidden'}}>{product.description}</p>
                    <h5 className="card-title text-secondary">${product.price}</h5>
